...
public class actions extends Driverlaunch1 {
	...
	public static void windowhandler_for_childid_backto_parentid(String locator) throws InterruptedException {
      ...
      public static void  double_click_plus(String locator) throws InterruptedException {
      for (int i = 0; i < 3; i++){
    	  //click the button
    	  driver.findElement(By.xpath(locator)).click();
    	  //wait 2 seconds
      ...
      public static void  double_click_minus (String locator) throws InterruptedException {
      for (int i = 0; i < 2; i++){
    	  //click the button
    	  driver.findElement(By.xpath(locator)).click();
    	  //wait 2 seconds
